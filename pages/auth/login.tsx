...
function Login() {
    ...
    return (
        <div className="relative flex w-screen min-h-full flex-col bg-black md:items-center md:justify-center md:bg-transparent">
            <Head>
            ...
            <div className="absolute top-0 left-0 w-48 h-24">
                <Image
                    ...
                    alt="Logo"
                    className="absolute -left-3 -top-6  object-contain md:left-0 md:-top-2"
                    fill
                    sizes="large"
                />
            </div>
